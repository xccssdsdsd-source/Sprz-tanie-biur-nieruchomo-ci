      ...
      <div className='relative mx-auto grid max-w-7xl grid-cols-1 gap-14 px-5 sm:px-8 lg:grid-cols-5'>
        ...
        >
          ...
          <button
            ...
            className='group mt-8 inline-flex w-full items-center justify-center gap-2 rounded-full bg-brand-dark px-7 py-4 text-base font-semibold text-white shadow-soft-lg outline-none transition-[transform,box-shadow,opacity] duration-200 hover:-translate-y-0.5 hover:shadow-soft-yellow focus-visible:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-brand-yellow focus-visible:ring-offset-2 active:translate-y-0 disabled:opacity-60 sm:w-auto'
          >
